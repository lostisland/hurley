...
module Hurley
  class QueryTest < TestCase
    def test_encode_and_parse_string_value
      ...
      assert_equal "a=1&a%2Bb=1%2B2", q.encode

      q2 = Query.parse(q.encode)
    ...
    def test_encode_and_parse_nil_value
      ...
      assert_equal "a=1&a%2Bb", q.encode
    ...
    def test_delete_value
      q = Query::Nested.new
      q["a+b"] = "1+2"
      assert_equal "a%2Bb=1%2B2", q.encode
      q.delete "a+b"
      assert_equal "", q.encode
    end
    ...
    def test_encode_and_parse_array_value_in_nested_query
      ...
      q["a"] = 1
      q["a+b"] = %w(1+1 2+2 3+3)
      assert_equal "a=1&a%2Bb[]=1%2B1&a%2Bb[]=2%2B2&a%2Bb[]=3%2B3", q.encode

      q2 = Query::Nested.parse(q.encode)
      assert_equal %w(a a+b), q2.keys
      assert_equal "1", q2["a"]
    ...
    def test_encode_and_parse_simple_hash_value_in_nested_query
      ...
      assert_equal "a=1&a%2Bb[1%2B1]=a%2Ba&a%2Bb[2%2B2]=b%2Bb", q.encode
    ...
    def test_encode_and_parse_deeply_nested_hash
      ...
      assert_equal "a=1&a%2B1[b%2B2][c%2B3]=d%2B4&a%2B1[b%2B2][c%2Bwat]=c&a%2B1[b%2Bwat]=b", q.encode
      q2 = Query::Nested.parse(q.encode)
    ...
    def test_encode_and_parse_deeply_nested_array
      ...
      assert_equal "a=1&a%2B1[b%2B2][c%2B3][]=d%2B4&a%2B1[b%2B2][c%2B3][]=d&a%2B1[b%2B2][c%2Bwat]=c&a%2B1[b%2Bwat]=b", q.encode
      q2 = Query::Nested.parse(q.encode)
      assert_equal %w(a a+1), q2.keys
      assert_equal "1", q2["a"]
    ...
    def test_encode_and_parse_deeply_nested_key
      ...
      assert_equal "a=1&a%2B1[][b%2B2][c%2B3][][d%2B4][]=e&a%2B1[][b%2B2][c%2B3][][d%2B4][]=5", q.encode
      q2 = Query::Nested.parse(q.encode)
      assert_equal %w(a a+1), q2.keys
      assert_equal "1", q2["a"]
